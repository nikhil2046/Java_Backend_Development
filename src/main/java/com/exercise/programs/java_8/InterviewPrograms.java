...
public class InterviewPrograms {
    public static void main(String[] args) {
        ...
        separateOddEvenNumber(listOfInteger);
        System.out.println("-----------------------------------------------------------------------------------");
        ...
        frequencyOfEachChanarcter(testString);
        System.out.println("-----------------------------------------------------------------------------------");
        ...
        frequencyOfCharacterFromGivenArray(listOfInteger);
        System.out.println("-----------------------------------------------------------------------------------");
        ...
        System.out.println("-----------------------------------------------------------------------------------");
        System.out.println("18. Rotate the array frm given index");
        rotateArrayFromGivenIndex(array1, 3);
    }

    private static void rotateArrayFromGivenIndex(int[] array1, int index) {
        int[] rotateArray = new int[array1.length];
        int rotateIndex = 0;
        for (int i = index; i < array1.length; i++) {
            rotateArray[rotateIndex++] = array1[i];
        }
    ...
    static void separateOddEvenNumber(List<Integer> integers) {
        Map<Boolean, List<Integer>> oddEvenNumbers = integers.stream()
                .collect(Collectors.partitioningBy(number -> number % 2 == 0));
        System.out.println("Odd Numbers : " + oddEvenNumbers.get(false));
        System.out.println("Even Numbers : " + oddEvenNumbers.get(true));
    }

    static void removeDuplicates(List<Integer> listOfInteger) {
    ...
    static void frequencyOfEachChanarcter(String testString) {
    ...
    static void frequencyOfCharacterFromGivenArray(List<Integer> listOfInteger) {
